...
contract RegistryConstants {
    ...
    bytes32 public constant MOC_PROJECT_VERSION = 0xc1c87e0508bb8270ee6a6dbe630baa072e6e3d5968981666724b9333430e1c31;

    // MOC_TOKEN = keccak256(moc.token)
    bytes32 public constant MOC_TOKEN = 0x4bd5e7ff929fdd1ba62a33f76e0f40e97bb35e8bf126c0d9d91ce5c69a4bc521;

    // MOC_DELAY_MACHINE = keccak256(moc.delay-machine)
    bytes32 public constant MOC_DELAY_MACHINE = 0x66b60892ff6e7f0da16db27046f5960fdfd6bce5c3c8c21d56ccca3236a6281b;

    // MOC_STAKING_MACHINE = keccak256(moc.staking-machine)
    bytes32 public constant MOC_STAKING_MACHINE = 0x3c557531fea67120f21bc7711270a96f1b8cff3dfe3dd798a8a9f09ce9b77972;

    // MOC_VESTING_MACHINE = keccak256(moc.vesting-machine)
    bytes32 public constant MOC_VESTING_MACHINE = 0x7dfea4fb968e2599cdb7b3028c07d0188d0f92d1d00bd95c2805523c224649dd;

    // MOC_VOTING_MACHINE = keccak256(moc.voting-machine)
    bytes32 public constant MOC_VOTING_MACHINE = 0xc0ded27704f62d8726fdbd83648113d9fd8cf32c09f80523d2ba523e0bbd5ba4;

    // MOC_VETO_MACHINE = keccak256(moc.veto-machine)
    bytes32 public constant MOC_VETO_MACHINE = 0x13e67b2e6ecb0b8faec5a951cfa640207bd15dfdbf6a0adef0ff4b4f0f089003;

    // MOC_UPGRADE_DELEGATOR = keccak256(moc.upgrade-delegator)
    bytes32 public constant MOC_UPGRADE_DELEGATOR = 0x631bcbb9b033f9c8d13c32cf6e60827348d77b91b58c295e87745219242cca22;
    ...
    bytes32 public constant SUPPORTERS_ADDR = 0xe4f979504d2a7a24557a15195eb83131e7c4a66d33900454705435aa5a6ee086;

    // INFO_ADDR = keccak256(MOC_ORACLE\1\INFO_ADDR)
    bytes32 public constant INFO_ADDR = 0xda9f12e01fc92de345bb741448d36ecb967052dd7aa1670439af833c9a3d78f1;
    ...
    bytes32 public constant SCHEDULER_POOL_DELAY = 0x6c2abc911c0fa4c73b90c7143a9f4429749be45ebfe7b81e69b86e7ca440d811;

    // SCHEDULER_ROUND_DELAY = keccak256(MOC_ORACLE\1\SCHEDULER_ROUND_DELAY)
    bytes32 public constant SCHEDULER_ROUND_DELAY = 0xa82bea7140872d1398fa0ab5075330ab0228f4c7e381b4b6502379ffc7cdcd9f;

    // ORACLE_PRICE_DIGITS = keccak256(MOC_ORACLE\1\ORACLE_PRICE_DIGITS)
    bytes32 public constant ORACLE_PRICE_DIGITS = 0x4cd7e3f12ee4a2db0a6ba16e03fbc31bba1048c149bbf4fc9f3c02021ec550b8;

    // ORACLE_QUEUE_LEN = keccak256(MOC_ORACLE\1\ORACLE_QUEUE_LEN)
    bytes32 public constant ORACLE_QUEUE_LEN = 0x7d32d87d65898c3cbc7e72c59d223bf61c7811e99dafafd24fb08e0a38f10914;

    // MESSAGE_VERSION = keccak256(MOC_ORACLE\1\MESSAGE_VERSION)
    bytes32 public constant MESSAGE_VERSION = 0xeafac1a2b4d4fdcc942cbdce334a88ec83387087978d039f1320d3639a0b59df;

    // ORACLE_PRICE_DELTA_PCT = keccak256(MOC_ORACLE\1\ORACLE_PRICE_DELTA_PCT)
    bytes32 public constant ORACLE_PRICE_DELTA_PCT = 0x41a2ac05b365409628009a8091d8dda06fe52fe2f1c792e651e5df7599a7a7de;
    ...
    bytes32 public constant MOC_FLOW_DRIPPERS = 0xdd6eacd9b2305faa48e6e500ef302cf28b8cd660dc843b355a6f5f26655eee73;

    // MOC_FLOW_COINERS = keccak256(MOC_FLOW\1\COINERS)
    bytes32 public constant MOC_FLOW_COINERS = 0x8970fe7a53b9c3dfce4f2afec48b5a6550afcb16ea2da8a10ec4b47a83a34a9d;
...
library RegistryConstantsLib {
    ...
    function MOC_VETO_MACHINE() internal pure returns (bytes32) {
        // keccak256(moc.voting-machine)
        return 0x13e67b2e6ecb0b8faec5a951cfa640207bd15dfdbf6a0adef0ff4b4f0f089003;
    }
